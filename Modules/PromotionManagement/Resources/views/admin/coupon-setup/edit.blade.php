                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="date" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $coupon->start_date)->format('Y-m-d') }}"
                                           id="start_date"
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="date" id="end_date"
                                           value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $coupon->end_date)->format('Y-m-d') }}" name="end_date"
