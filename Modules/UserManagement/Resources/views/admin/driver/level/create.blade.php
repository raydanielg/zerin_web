                                            ...
                                            <div class="col-sm-6 col-xl-5">
                                                <div class="mb-4">
                                                    <label for="select_level_number"
                                                           class="mb-2">
                                                        {{translate('select_level_sequence')}}
                                                ...
                                                <div class="mb-4">
                                                    <label for="l_name" class="mb-2">
                                                        {{translate('level_name')}}
                                                        <span class="text-danger">*</span>
                                                    </label>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="d-flex flex-column justify-content-around gap-3">
                                                    <h5 class="text-center text-capitalize">
                                                        {{translate('level_icon')}}
                                                        <span class="text-danger">*</span>
                                                    </h5>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="upload-file auto border-light-mode profile-image-upload-file cmn_focus rounded-10">
                            ...
                            <div class="col-xl-9">
                                <div class="card mb-4">
                                    <div class="card-header pt-4 border-0 text-center">
                                        <h5 class="text-capitalize mb-2 pt-2">
