                                        ...
                                        <div class="row g-4 justify-content-between align-items-center">
                                            <div class="col-sm-6 col-xl-5">
                                                <div class="mb-4">
                                                    <label for="select_level_number"
                                                           class="mb-2">{{translate('select_level_sequence')}}<span class="text-danger">*</span></label>
                                                ...
                                                <div class="mb-4">
                                                    <label for="l_name" class="mb-2">{{translate('level_name')}}<span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="d-flex flex-column justify-content-around gap-3">
                                                    <h5 class="text-center text-capitalize">{{translate('level_icon')}}<span class="text-danger">*</span></h5>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="upload-file cmn_focus auto profile-image-upload-file">
                                                            ...
                                                            <div
                                                                class="upload-file__img border-light-mode border-gray d-flex justify-content-center align-items-center w-150 h-150 aspect-1 p-0">
                    ...
                    <div class="card-body pb-5">
                        <div class="row justify-content-center">
                            <div class="col-xl-9">
                                                ...
                                                <div class="row align-items-end g-4">
                                                    <div class="col-sm-6">
                                                        <label for="rewardType"
                                                               class="mb-2">{{translate('reward_type')}}<span class="text-danger">*</span></label>
                                ...
                                <div class="card">
                                    <div class="card-header pt-4 border-0 text-center">
                                        <h5 class="text-capitalize mb-2 pt-2">{{translate('Set Target to Promote from This Level')}}<span class="text-danger">*</span></h5>
    ...
    <script>
        ...
        function hideReward() {
            ...
            if (value !== 'no_rewards') {
                ...
                $('#rewardAmountLabel').append('<span class="text-danger">*</span>');
