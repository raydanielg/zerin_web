<div class="tab-pane fade active show" id="today-tab-pane" role="tabpanel">
                ...
                <div class="leader-board d-flex flex-column align-items-center">
                    ...
                    <div class="custom-box-size rounded-circle position-relative" style="--size: 65px">
                        ...
                        <img src="{{ onErrorImage(
                            ...
                            dynamicStorage('storage/app/public/driver/profile') . '/' . $leadDriver[1]?->driver?->profile_image,
            ...
            @else
                <div class="leader-board d-flex flex-column align-items-center">
                    ...
                    <div class="custom-box-size rounded-circle position-relative" style="--size: 65px">
                        ...
                        <img src="{{ dynamicAsset('public/assets/admin-module/img/driver.png') }}"
                             alt="" class="fit-object rounded-circle dark-support">
                    </div>
                    <div class="leader-board-column second bg-warning mt-3">
                        <span class="leader-board-position text-warning mx-auto"> 2 </span>
                ...
                <div class="leader-board d-flex flex-column align-items-center">
                    ...
                    <div class="custom-box-size rounded-circle position-relative" style="--size: 65px">
                        <img src="{{ onErrorImage(
                            ...
                            dynamicStorage('storage/app/public/driver/profile') . '/' . $leadDriver[0]?->driver?->profile_image,
                            dynamicAsset('public/assets/admin-module/img/avatar/avatar.png'),
                            'driver/profile/',
                        ) }}"
                            alt="" class="fit-object rounded-circle dark-support">
                        <img width="36" src="{{ dynamicAsset('public/assets/admin-module/img/icons/badge.png') }}"
                ...
                <div class="leader-board d-flex flex-column align-items-center">
                    ...
                    <div class="custom-box-size rounded-circle position-relative" style="--size: 65px">
                        <img src="{{ onErrorImage(
                            ...
                            dynamicStorage('storage/app/public/driver/profile') . '/' . $leadDriver[2]?->driver?->profile_image,
                            dynamicAsset('public/assets/admin-module/img/avatar/avatar.png'),
                            'driver/profile/',
                        ) }}"
                            alt="" class="fit-object rounded-circle dark-support">
                ...
                @forelse($leadDriver as $key => $ld)
                    <li>
                        <div class="d-flex align-items-center gap-3">
                            <div>{{ ++$key }}.</div>
                            <a href="{{ route('admin.driver.show', $ld->driver->id) }}" target="_blank"
                               class="media align-items-center gap-3">
                                <div class="avatar avatar-sm rounded-circle">
                                    <img src="{{ onErrorImage(
                                        $ld?->driver?->profile_image,
                                        dynamicStorage('storage/app/public/driver/profile') . '/' . $ld?->driver?->profile_image,
                                        dynamicAsset('public/assets/admin-module/img/avatar/avatar.png'),
                                        'driver/profile/',
                                    ) }}"
                                ...
                                <div class="media-body">
                                    {{ $ld->driver?->first_name . ' ' . $ld->driver?->last_name }}
                                </div>
                            </a>
                        </div>
    ...
    @else
        <div class="py-3">
            <div class="d-flex flex-column justify-content-center align-items-center gap-2 py-3">
                <img src="{{ dynamicAsset('public/assets/admin-module/img/driver.png') }}" alt="" width="100">
