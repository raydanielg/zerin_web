...
@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <form id="vehicle_form" action="{{ route('admin.vehicle.update', ['id' => $vehicle->id]) }}" enctype="multipart/form-data"
                method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4" id="model-selector">
                                            ...
                                            <select class="theme-input-style w-100 form-control js-select"
                                                name="model_id" id="model_id"
                                                data-placeholder="{{ translate('First, select a brand') }}" required tabindex="2">
...
@push('script')
    ...
    <script>
        ...
        $('#vehicle_form').on('submit', function (event) {
            if ($('#model_id').val() === null || $('#model_id').val() === 'select_model') {
