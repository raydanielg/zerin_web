                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-end mb-2">
                                    <img src="{{ onErrorImage(
                                        ...
                                        dynamicAsset('public/assets/admin-module/img/media/car2.png'),
                                        'vehicle/category/',
                                    ) }}"
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($vehicles as $key => $vehicle)
                                                    <tr id="hide-row-{{ $vehicle->id }}" class="record-row">
                                                        ...
                                                        <td><a href="{{ route('admin.vehicle.show', $vehicle->id) }}">#{{ $vehicle?->ref_id }}</a></td>
                                                        ...
                                                        <td class="sl">
                                                            <div class="avatar bg-transparent rounded">
                                                                <img src="{{ onErrorImage(
                                                                    ...
                                                                    dynamicStorage('storage/app/public/vehicle/category') . '/' . $vehicle?->category?->image,
