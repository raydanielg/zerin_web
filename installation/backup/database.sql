...
--
-- Host: localhost
-- Generation Time: Mar 12, 2026 at 08:57 AM
...
CREATE TABLE `trip_navigations` (
  ...
  `encoded_polyline` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trip_requests` (
  ...
  `pickup_note` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `logged_in_via` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
